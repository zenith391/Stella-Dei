...
pub const NK_API = @compileError("unable to translate C expr: unexpected token 'extern'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:264:13
pub const NK_LIB = @compileError("unable to translate C expr: unexpected token 'static'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:269:13
pub const NK_INTERN = @compileError("unable to translate C expr: unexpected token 'static'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:275:9
pub const NK_STORAGE = @compileError("unable to translate C expr: unexpected token 'static'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:276:9
pub const NK_GLOBAL = @compileError("unable to translate C expr: unexpected token 'static'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:277:9
pub const NK_STRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:280:9
pub const NK_STRING_JOIN_IMMEDIATE = @compileError("unable to translate C expr: unexpected token '##'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:282:9
pub const NK_UNIQUE_NAME = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:289:11
pub const NK_STATIC_ASSERT = @compileError("unable to translate macro: undefined identifier `_dummy_array`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:293:11
pub const NK_FILE_LINE = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:300:11
pub const nk_foreach = @compileError("unable to translate C expr: unexpected token 'for'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:1229:9
pub const nk_draw_foreach = @compileError("unable to translate C expr: unexpected token 'for'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:1320:9
pub const nk_tree_push = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:2890:9
pub const nk_tree_image_push = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:2950:9
pub const nk_tree_element_push = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:3048:9
pub const nk_draw_list_foreach = @compileError("unable to translate C expr: unexpected token 'for'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:4811:9
pub const NK_CONFIGURATION_STACK_TYPE = @compileError("unable to translate macro: undefined identifier `nk_config_stack_`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5541:9
pub const NK_CONFIG_STACK = @compileError("unable to translate macro: undefined identifier `nk_config_stack_`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5546:9
pub const NK_LEN = @compileError("unable to translate C expr: expected ')' instead got '['"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5672:9
pub const nk_ptr_add = @compileError("unable to translate C expr: unexpected token ')'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5688:9
pub const nk_ptr_add_const = @compileError("unable to translate C expr: unexpected token 'const'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5689:9
pub const nk_zero_struct = @compileError("unable to translate macro: undefined identifier `nk_zero`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5690:9
pub const NK_OFFSETOF = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5716:9
pub const NK_ALIGNOF = @compileError("unable to translate macro: undefined identifier `c`"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5733:9
pub const NK_CONTAINER_OF = @compileError("unable to translate C expr: unexpected token ')'"); // /media/randy/Données/home/randy/Name-Not-Included/deps/nuklear.h:5736:9
...
pub const NK_INCLUDE_VERTEX_BUFFER_OUTPUT = "";
pub const NK_INCLUDE_FONT_BAKING = "";
pub const NK_INCLUDE_DEFAULT_FONT = "";
